...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Story.cover_image'
        db.add_column('lstory_story', 'cover_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


        # Changing field 'Story.region'
        db.alter_column('lstory_story', 'region', self.gf('ltools.fields.CountryField')(max_length=255))

    def backwards(self, orm):
        # Deleting field 'Story.cover_image'
        db.delete_column('lstory_story', 'cover_image')


        # Changing field 'Story.region'
        db.alter_column('lstory_story', 'region', self.gf('django.db.models.fields.CharField')(max_length=255))
