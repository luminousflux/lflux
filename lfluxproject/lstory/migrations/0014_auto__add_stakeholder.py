...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('lstory', ['Stakeholder'])


    def backwards(self, orm):
        # Deleting model 'Stakeholder'
        db.delete_table('lstory_stakeholder')
