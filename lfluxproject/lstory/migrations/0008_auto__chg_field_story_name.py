...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('lstory_story', 'name', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
    def backwards(self, orm):

        # Changing field 'Story.name'
        db.alter_column('lstory_story', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    models = {
        'auth.group': {
