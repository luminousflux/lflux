...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StorySummary'
        db.create_table('lstory_storysummary', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('story', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lstory.Story'])),
            ('timeframe_start', self.gf('django.db.models.fields.DateTimeField')()),
            ('timeframe_end', self.gf('django.db.models.fields.DateTimeField')()),
            ('body', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('lstory', ['StorySummary'])

    def backwards(self, orm):
        # Deleting model 'StorySummary'
        db.delete_table('lstory_storysummary')
