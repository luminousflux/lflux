...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChangeSuggestion'
        db.create_table('lstory_changesuggestion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('summary', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('body', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('story', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lstory.Story'])),
            ('for_version', self.gf('django.db.models.fields.DateTimeField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('lstory', ['ChangeSuggestion'])


    def backwards(self, orm):
        # Deleting model 'ChangeSuggestion'
        db.delete_table('lstory_changesuggestion')
    ...
    models = {
        ...
        'lstory.changesuggestion': {
            ...
            'for_version': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
