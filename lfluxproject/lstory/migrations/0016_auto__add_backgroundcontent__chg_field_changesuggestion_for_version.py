...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BackgroundContent'
        db.create_table('lstory_backgroundcontent', (
        ...
        db.send_create_signal('lstory', ['BackgroundContent'])


        # Changing field 'ChangeSuggestion.for_version'
        db.alter_column('lstory_changesuggestion', 'for_version', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting model 'BackgroundContent'
        db.delete_table('lstory_backgroundcontent')


        # Changing field 'ChangeSuggestion.for_version'
        db.alter_column('lstory_changesuggestion', 'for_version', self.gf('django.db.models.fields.DateTimeField')())
