...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StorySummary.author'
        db.add_column('lstory_storysummary', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'StorySummary.author'
        db.delete_column('lstory_storysummary', 'author_id')
