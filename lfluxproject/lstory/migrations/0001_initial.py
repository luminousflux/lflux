...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lstory_story', (
            ...
            ('timeframe_start', self.gf('django.db.models.fields.DateField')(null=True)),
            ('timeframe_end', self.gf('django.db.models.fields.DateField')(null=True)),
            ('region', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal('lstory', ['Story'])

        # Adding M2M table for field authors on 'Story'
        db.create_table('lstory_story_authors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('story', models.ForeignKey(orm['lstory.story'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('lstory_story_authors', ['story_id', 'user_id'])


    def backwards(self, orm):
        
        # Deleting model 'Story'
        db.delete_table('lstory_story')

        # Removing M2M table for field authors on 'Story'
        db.delete_table('lstory_story_authors')
