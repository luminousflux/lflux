...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lqa_question', (
            ...
            ('state', self.gf('django.db.models.fields.TextField')(default=('new', 'new'), max_length=255)),
        ))
        db.send_create_signal('lqa', ['Question'])


    def backwards(self, orm):
        # Deleting model 'Question'
        db.delete_table('lqa_question')
    ...
    models = {
        ...
        'lqa.question': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'state': ('django.db.models.fields.TextField', [], {'default': "('new', 'new')", 'max_length': '255'}),
